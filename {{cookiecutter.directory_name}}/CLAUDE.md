...
Instructions for Claude Code agents working in this repository. Codex and other
terminal agents should follow the same rules in `AGENTS.md`; keep both files
aligned when agent workflow rules change.
